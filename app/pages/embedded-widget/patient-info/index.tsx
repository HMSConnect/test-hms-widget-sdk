...
const PatientInfoPrepareWidget: IStatelessPage<{
  query: any
}> = ({ query }) => {
  return (
...
PatientInfoPrepareWidget.getInitialProps = async ({ req, res, query }) => {
  return {
    query,
  }
}

export default withAuthSync(PatientInfoPrepareWidget)
